            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown dropdown-notification nav-item mr-2"><a class="nav-link nav-link-label"
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                <span class="user-status">
                                    ...
                                    Administrador
                                    @elseif (Auth::user() && Auth::user()->roles == 1)
                                    Usuário
                                    @else
                                    Cliente
                                    @endif
                            ...
                            <span>
                                <img class="round"
                                    src="{{ asset('img').'/'.  (Auth::user() ? Auth::user()->avatar : '') }}"
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="dropdown-item w-100"><i class="feather icon-power"></i>
                                    Logout</button>
                            </form>
                        </div>
                    </li>
